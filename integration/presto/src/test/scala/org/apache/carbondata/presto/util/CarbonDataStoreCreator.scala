...
object CarbonDataStoreCreator {
  ...
  private def createTable(absoluteTableIdentifier: AbsoluteTableIdentifier): CarbonTable = {
    ...
    val dictionaryEncodingString: ArrayList[Encoding] = new ArrayList[Encoding]()
    ...
    country.setEncodingList(dictionaryEncodingString)
    ...
    name.setEncodingList(dictionaryEncodingString)
    ...
    phonetype.setEncodingList(dictionaryEncodingString)
    ...
    serialname.setEncodingList(dictionaryEncodingString)
